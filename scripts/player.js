class Player {
  ...
  prettyTime(timeInSeconds){
    timeInSeconds = Math.floor(getDuration());
    const m: timeInSeconds.getMinutes();
    

    return currentTime.player.prettyTime();
    return totaltime.player.prettyTime();
    return getDuration.player.prettyTime();
  }
}
